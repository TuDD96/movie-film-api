...
class ErrorType extends BaseEnum
{
    ...
    // email invite has expired
    // メール招待の有効期限が切れました
    const CODE_4017 = '4017';
    const STATUS_4017 = 401;
    ...
    // パスワードが間違っています
    const CODE_4034 = '4034';

    const STATUS_4034 = 403;
