        ...
        var picker = {},
            ...
            _doTimeInc = function (timetable, input) {
                ...
                if (inputType === 'h') {
                    ...
                    var seconds = (currentDate.getSeconds() + 10) % 60;
            ...
            _doTimeDec = function (timetable, input) {
                ...
                if (inputType === 'h') {
                    ...
                    var minutes = (currentDate.getMinutes() + 59) % 60;
                    currentDate.setMinutes(minutes);
                    timetable.$m.val(utilsLeftPad(minutes, 2, '0'));
                } else {
                    var seconds = (currentDate.getSeconds() + 50) % 60;
                    currentDate.setSeconds(seconds);
                    timetable.$s.val(utilsLeftPad(seconds, 2, '0'));
                }
                input.select();
    ...
    $.fn.datetimepicker.CONSTS = {
        I18N: {
            ...
            jp: {
                SDN: ["日", "月", "火", "水", "木", "金", "土"],
                MN: ["一月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月", "十一月", "十二月"],
                DN: ["日曜日", "月曜日", "火曜日", "水曜日", "木曜日", "金曜日", "土曜日"],
                CALENDAR: "カレンダー",
                CLEAR: "削除",
                TODAY: "今日",
                OK: "OK",
